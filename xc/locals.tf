locals {
  ...
  origin_server = "${coalesce(local.origin_bigip, local.origin_nginx, var.serviceName, data.tfe_outputs.infra.values.public_ip)}"
  #59origin_port = try(data.tfe_outputs.nap.values.external_port, data.tfe_outputs.nic.values.external_port, "80")
  origin_port = try(data.tfe_outputs.nap[0].values.external_port, data.tfe_outputs.nic[0].values.external_port, data.tfe_outputs.infra.values.arcadia_port, "80")
